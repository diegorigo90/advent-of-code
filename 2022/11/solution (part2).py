...
for round_item in range(0, 10000):
    ...
    if round_item % 1000 == 0:
        print(f"== After round {round_item} ==")
        for monkey in monkeys:
...
business_value = monkeys[0]['inspections'] * monkeys[1]['inspections']
print(f"AFFARI: {business_value}")
